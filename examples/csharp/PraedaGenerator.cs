...
namespace Praeda {
    ...
    internal static class NativeMethods {
        // Library name - use relative path that works from the project directory
        // DllImport requires a constant, so we use the relative path that works with dotnet run
        ...
        public static extern int praeda_generator_load_toml(
            IntPtr handle,
            [MarshalAs(UnmanagedType.LPUTF8Str)] string tomlStr,
            out IntPtr errorOut
        );
        ...
        public static extern int praeda_generator_set_quality_data(
            IntPtr handle,
            [MarshalAs(UnmanagedType.LPUTF8Str)] string qualityName,
            int weight
        );
        ...
        public static extern int praeda_generator_set_item_subtype(
            IntPtr handle,
            [MarshalAs(UnmanagedType.LPUTF8Str)] string typeName,
            [MarshalAs(UnmanagedType.LPUTF8Str)] string subtypeName,
            int weight
        );
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        public static extern int praeda_generator_set_prefix_attribute(
            IntPtr handle,
            [MarshalAs(UnmanagedType.LPUTF8Str)] string typeName,
            [MarshalAs(UnmanagedType.LPUTF8Str)] string subtypeName,
            [MarshalAs(UnmanagedType.LPUTF8Str)] string affixName,
            [MarshalAs(UnmanagedType.LPUTF8Str)] string attrName,
            double initialValue,
            double minValue,
            double maxValue,
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        public static extern int praeda_generator_set_suffix_attribute(
            IntPtr handle,
            [MarshalAs(UnmanagedType.LPUTF8Str)] string typeName,
            [MarshalAs(UnmanagedType.LPUTF8Str)] string subtypeName,
            [MarshalAs(UnmanagedType.LPUTF8Str)] string affixName,
        ...
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        public static extern int praeda_generator_has_quality(IntPtr handle, [MarshalAs(UnmanagedType.LPUTF8Str)] string quality);
    ...
    public class PraedaGenerator : IDisposable {
        ...
        /// </summary>
        public bool SetPrefixAttribute(string typeName, string subtypeName, string affixName,
                                       ItemAttribute attribute) {
            ThrowIfDisposed();
            int result = NativeMethods.praeda_generator_set_prefix_attribute(
                handle, typeName, subtypeName, affixName, attribute.Name,
                attribute.InitialValue, attribute.Min, attribute.Max,
        ...
        /// </summary>
        public bool SetSuffixAttribute(string typeName, string subtypeName, string affixName,
                                       ItemAttribute attribute) {
            ThrowIfDisposed();
            int result = NativeMethods.praeda_generator_set_suffix_attribute(
                handle, typeName, subtypeName, affixName, attribute.Name,
                attribute.InitialValue, attribute.Min, attribute.Max,
                attribute.Required ? 1 : 0
            );
